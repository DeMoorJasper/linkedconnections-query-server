    ...
    _read() {
        if (this.discoveryPhase) {
            ...
            this.cache.get(this.starturl).then(response => {
                ...
                var metaTriples = response.triples.filter(triple => triple.predicate === 'http://www.w3.org/ns/hydra/core#search' ||
                ...
                var searchUriTriples = metaTriples.filter(triple => triple.predicate === 'http://www.w3.org/ns/hydra/core#search' &&
                ...
                searchUriTriples.forEach(searchUriTriple => {
                    ...
                    var mappings = metaTriples.filter(triple => triple.subject === searchUri && triple.predicate === 'http://www.w3.org/ns/hydra/core#mapping');
